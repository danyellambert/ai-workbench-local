...
- Local Docker uses .env.docker and docker-compose.oracle-like.yml.
- AWS slim uses .env.aws, docker-compose.oracle-like.yml, and docker-compose.aws-slim.override.yml.
