...
const LAB_EVIDENCEOPS_TOUR_STEPS: TourStep[] = [
  {
    ...
    eyebrow: 'Step 1 - MCP Operations',
    title: 'Finish the AI Lab with operations and governance.',
    body: 'MCP Operations is the operational console: local MCP tool health, backlog actions, automated operations, repository readiness, telemetry, and search.',
    placement: 'below',
    scrollBlock: 'start',
    spotlightOffset: { x: -10, y: -16, width: 20, height: 20 },
  },
  {
    ...
    eyebrow: 'Step 2 - MCP Operations KPIs',
  ...
  },
  {
    ...
    body: 'The local MCP-console heading and first tool rows list repository, action, and worklog operations exposed by the local MCP Operations server. The remaining tabs stay available for readiness, telemetry, timeline, backlog actions, and repository search.',
    placement: 'below',
    scrollBlock: 'center',
    panelWidth: 390,
    forcePlacement: true,
