...
def _sample_document_agent_result() -> StructuredResult:
    payload = DocumentAgentPayload(
        ...
        key_points=[
            "Nova obrigação de aprovação formal.",
            "Owner do controle anual ainda não foi definido.",
        ],
...
def _sample_action_entries() -> list[dict[str, object]]:
    return [
        ...
        {
            "action_type": "recommended_action",
            "description": "Validar sign-off jurídico",
            "owner": "Legal",
            "due_date": "2026-04-12",
            "status": "in_progress",
            "review_type": "risk_gap_review",
    ...
    return [
        {
            ...
            "limitations": ["Uma evidência ainda depende de validação manual"],
        }
    ]
