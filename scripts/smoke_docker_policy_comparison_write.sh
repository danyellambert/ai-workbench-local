...
REPORT_OUT="${AI_DECISION_STUDIO_DOCKER_POLICY_COMPARISON_REPORT:-../ai_decision_studio_functional_baseline/current_docker_policy_comparison_write_smoke_report.json}"
