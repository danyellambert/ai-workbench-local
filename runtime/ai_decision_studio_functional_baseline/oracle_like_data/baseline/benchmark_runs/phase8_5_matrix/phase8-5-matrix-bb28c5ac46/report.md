me# Phase 8.5 Benchmark Report

- Run ID: `phase8-5-matrix-bb28c5ac46`
...
| --- | --- | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ollama` | `qwen3.5:4b` | `direct_runtime` | `ollama::qwen3.5:4b` | 1.0000 | 1.0000 | 9.3903 |
...
| --- | --- | ---: | ---: | ---: | --- | --- |
| `ollama` | `qwen3.5:4b` | 9.3903 | 2.9604 | 13.5414 | `{"measured": 2}` | `{"measured": 2}` |

## Embedding ranking

| Rank | Provider | Model | Role | Runtime path | Backend | Avg MRR | Avg Hit@1 | Avg retrieval (s) |
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| 1 | `ollama` | `embeddinggemma:300m` | `baseline_general_retrieval` | `direct_runtime` | `ollama::embeddinggemma:300m` | 0.5000 | 0.5000 | 0.1423 |
| 2 | `ollama` | `embeddinggemma:300m` | `baseline_general_retrieval` | `direct_runtime` | `ollama::embeddinggemma:300m` | 0.5000 | 0.5000 | 0.6712 |
...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| 1 | `vector_only_local_baseline` | `ollama` | `embeddinggemma:300m` | `direct_runtime` | `ollama_local` | `baseline` | 0.5000 | 0.5000 | 0.6143 | 0.5000 |

## OCR / VLM leaderboard

| Rank | Variant | Runtime family | Avg F1 | Avg latency (s) | Helped cases |
| --- | --- | --- | ---: | ---: | ---: |
| 1 | `evidence_with_vl` | `ollama_local` | 1.0000 | 0.5143 | 1 |
| 2 | `evidence_no_vl_docling_disabled` | `huggingface_local` | 1.0000 | 0.5334 | 1 |
| 3 | `evidence_no_vl` | `huggingface_local` | 1.0000 | 0.9925 | 1 |
| 4 | `legacy_pdf` | `legacy_pdf_text_extraction` | 0.2500 | 0.0374 | 0 |
| 5 | `pdf_hybrid` | `pdf_hybrid_local` | 0.2500 | 0.0384 | 0 |
| 6 | `pdf_complete` | `pdf_complete_local` | 0.2500 | 14.7259 | 0 |
